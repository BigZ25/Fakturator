                        ...
                        @foreach($items as $index => $item)
                            <tr>
                                @if(!$onlyShow)
                                    ...
                                    @include('modules.invoices.items.partials.name_input',['name' => 'items['.$index.'][name]','model' => 'items.'.$index.'.name','value' => $item['name'],'width' => 30,'datalist' => true,'options' => $lists['products'],'index' => $index])
