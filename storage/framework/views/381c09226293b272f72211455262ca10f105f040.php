...
<?php endif; ?>
        ...
        ?>
        <input <?php if($datalist === true): ?> list="<?php echo e($datalistId); ?>" <?php endif; ?> <?php echo e($attributes->class([
        ...
        <?php if($datalist === true): ?>
            <datalist id="<?php echo e($datalistId); ?>">
...
<?php /**PATH C:\laragon\www\fakturator\resources\views/vendor/wireui/components/my-input.blade.php ENDPATH**/ ?>