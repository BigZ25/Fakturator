<div x-data="wireui_inputs_maskable({
    isLazy: false,
    model: window.Livewire.find('uUiVvdOPlnNNQLibdZRc').entangle('data.postcode'),
    emitFormatted: false,
    mask: &#039;##-###&#039;,
})" >
    <div class="">
...
<?php /**PATH C:\laragon\www\fakturator\storage\framework\views/7ee6b774583d29582b69bffeaafeacb3d255096e.blade.php ENDPATH**/ ?>