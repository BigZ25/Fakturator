<div x-init="'2023-05-16' ? selectDate(setDate('2023-05-16')) : ''"
     x-data="wireui_datetime_picker({
        model: window.Livewire.find('VKp7rGjxq0nN3KFf7lvX').entangle(''),
        config: {
            interval: 10,
            is12H:    true,
            readonly: false,
...
<?php /**PATH C:\laragon\www\fakturator\storage\framework\views/a1e0b0571ae3a6294fde7850d287fc5cb123c7d7.blade.php ENDPATH**/ ?>