<div x-data="wireui_inputs_maskable({
    isLazy: false,
    model: window.Livewire.find('AUCjMxrFOffmId00WbD1').entangle('data.postcode'),
    emitFormatted: false,
    mask: &#039;##-###&#039;,
})" >
    <div class="">
...
<?php /**PATH C:\laragon\www\fakturator\storage\framework\views/777913efc113abac257fec767c24a3dae8a34d71.blade.php ENDPATH**/ ?>