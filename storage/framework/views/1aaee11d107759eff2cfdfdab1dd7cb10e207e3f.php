...
<?php $component->withAttributes(['class' => 'mr-2','for' => $id,'label' => $leftLabel,'has-error' => $errors->has($name)]); ?>
...
<?php endif; ?>
        ...
        <input
            ...
            <?php endif; ?>
            value="1"
            <?php echo e($attributes->class([$getClasses($errors->has($name)),])->merge(['type'  => 'checkbox'])); ?>
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['class' => 'ml-2','for' => $id,'label' => $label,'has-error' => $errors->has($name)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal3bf0a20793be3eca9a779778cf74145887b021b9)): ?>
<?php $component = $__componentOriginal3bf0a20793be3eca9a779778cf74145887b021b9; ?>
...
<?php /**PATH C:\laragon\www\fakturator\resources\views/vendor/wireui/components/binary-checkbox.blade.php ENDPATH**/ ?>