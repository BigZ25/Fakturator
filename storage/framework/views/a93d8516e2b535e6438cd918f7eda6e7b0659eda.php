<div x-data="wireui_inputs_maskable({
    isLazy: false,
    model: window.Livewire.find('31UuBd2bIutB09LmZRAN').entangle('data.postcode'),
    emitFormatted: false,
    mask: &#039;##-###&#039;,
})" >
    <div class="">
...
<?php /**PATH C:\laragon\www\fakturator\storage\framework\views/7cefa54ace8a35b2da813099a36e67128d2d9ac1.blade.php ENDPATH**/ ?>