<div x-init="'2023-05-16' ? selectDate(setDate('2023-05-16')) : ''"
     x-data="wireui_datetime_picker({
        model: window.Livewire.find('xkMfS1nZSo7fsyEP5Rw5').entangle(''),
        config: {
            interval: 10,
            is12H:    true,
            readonly: false,
...
<?php /**PATH C:\laragon\www\fakturator\storage\framework\views/6df0dbc2f45d1c6557deaef48ae820be982978af.blade.php ENDPATH**/ ?>