...
<div>
    <?php if(isset($actions) && count($actions) && $row !== ''): ?>
        <td class="pg-actions <?php echo e($theme->table->tdBodyClass); ?>"
            style="<?php echo e($theme->table->tdBodyStyle); ?> text-align: center;">
...
<?php $component = $__env->getContainer()->make(WireUi\View\Components\Icon::class, ['name' => ''.e($actionClass->getDynamicProperty('icon')).'']); ?>
...
<?php endif; ?>
                                <?php echo nbsp($actionClass->caption()); ?>
...
<?php $component = $__env->getContainer()->make(Illuminate\View\DynamicComponent::class, ['component' => $actionClass->bladeComponent]); ?>
...
<?php /**PATH C:\laragon\www\fakturator\resources\views/vendor/livewire-powergrid/components/actions.blade.php ENDPATH**/ ?>