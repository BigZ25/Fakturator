<div x-data="wireui_inputs_maskable({
    isLazy: false,
    model: window.Livewire.find('XaVNhPpWNeR81FlAd4Ho').entangle('data.postcode'),
    emitFormatted: false,
    mask: &#039;##-###&#039;,
})" >
    <div class="">
...
<?php /**PATH C:\laragon\www\fakturator\storage\framework\views/45ce1dfa2511daaa6f0e089db3dc6c6bbb7591ff.blade.php ENDPATH**/ ?>