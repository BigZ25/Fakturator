<div x-data="wireui_inputs_maskable({
    isLazy: false,
    model: window.Livewire.find('3MXsMmsZjLYY1ICJXocV').entangle('data.postcode'),
    emitFormatted: false,
    mask: &#039;##-###&#039;,
})" >
    <div class="">
...
<?php /**PATH C:\laragon\www\fakturator\storage\framework\views/c71cf129f3bca49666fc5b12803a3100881b1a47.blade.php ENDPATH**/ ?>