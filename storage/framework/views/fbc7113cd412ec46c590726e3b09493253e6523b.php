...
<?php endif; ?>
            ...
            <?php if(isset($actions) && count($actions)): ?>
                <th class="<?php echo e($theme->table->thClass .' '. $column->headerClass); ?>" scope="col"
                    style="<?php echo e($theme->table->thStyle); ?> text-align: center;" colspan="<?php echo e(count($actions )); ?>"
        ...
        <?php if(is_null($data) || count($data) === 0): ?>
            <th>
                <tr class="<?php echo e($theme->table->trBodyClass); ?>" style="<?php echo e($theme->table->trBodyStyle); ?>">
                    <td class="<?php echo e($theme->table->tdBodyClass); ?> text-center" style="<?php echo e($theme->table->tdBodyStyle); ?>" colspan="<?php echo e((($checkbox) ? 1:0)
                                    + ((isset($actions)) ? 1: 0)
                                    + (count($columns))); ?>">
            ...
            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php else: ?>
                    <tr style="<?php echo e($theme->table->trBodyStyle); ?>"
                        ...
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'livewire-powergrid::components.actions','data' => ['primaryKey' => $primaryKey,'tableName' => $tableName,'theme' => $theme,'row' => $row,'actions' => $actions]]); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH C:\laragon\www\fakturator\resources\views/vendor/livewire-powergrid/components/table.blade.php ENDPATH**/ ?>