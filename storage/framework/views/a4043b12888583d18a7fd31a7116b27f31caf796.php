<div x-data="wireui_inputs_maskable({
    isLazy: false,
    model: window.Livewire.find('zyyJhAnhYuuYHcTDOtiu').entangle('data.postcode'),
    emitFormatted: false,
    mask: &#039;##-###&#039;,
})" >
    <div class="">
...
<?php /**PATH C:\laragon\www\fakturator\storage\framework\views/dfa1dddf5bd6f3488394ab8f033cfe9987aa483e.blade.php ENDPATH**/ ?>