<div x-data="wireui_inputs_maskable({
    isLazy: false,
    model: window.Livewire.find('P0nSt9tjzhP8mIUgH7aK').entangle('data.postcode'),
    emitFormatted: false,
    mask: &#039;##-###&#039;,
})" >
    <div class="">
...
<?php /**PATH C:\laragon\www\fakturator\storage\framework\views/ec6351112689811a594c12554dbe36a09967cb00.blade.php ENDPATH**/ ?>