<div x-init="'2023-06-15' ? selectDate(setDate('2023-06-15')) : ''"
     x-data="wireui_datetime_picker({
        model: window.Livewire.find('MsvelB2kxUzAjxIYcNRN').entangle(''),
        config: {
            interval: 10,
            is12H:    true,
            readonly: false,
...
<?php /**PATH C:\laragon\www\fakturator\storage\framework\views/986ca754405845988af2db8f20bb3d3762b9a393.blade.php ENDPATH**/ ?>