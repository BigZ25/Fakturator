<div x-init="'2023-05-16' ? selectDate(setDate('2023-05-16')) : ''"
     x-data="wireui_datetime_picker({
        model: window.Livewire.find('ShFpM8aWTwCNJIp66Aou').entangle(''),
        config: {
            interval: 10,
            is12H:    true,
            readonly: false,
...
<?php /**PATH C:\laragon\www\fakturator\storage\framework\views/e4e9170108a615b69dfef2cfb6dae87eddf9edd4.blade.php ENDPATH**/ ?>