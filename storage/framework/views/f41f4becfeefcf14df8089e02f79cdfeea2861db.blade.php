<div class="">
    ...
    Stawka VAT
        ...
        <select class="form-select block w-full pl-3 pr-10 py-2 text-base sm:text-sm shadow-sm
                ...
                dark:bg-secondary-800 dark:border-secondary-600 dark:text-secondary-400 border-secondary-300 focus:ring-primary-500 focus:border-primary-500" name="vat_type" wire:model="">
