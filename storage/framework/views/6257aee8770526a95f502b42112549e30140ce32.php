<div x-data="wireui_inputs_maskable({
    isLazy: false,
    model: window.Livewire.find('3A8KIO6BUClHB0jo43A6').entangle('data.nip'),
    emitFormatted: false,
    mask: &#039;#############&#039;,
})" >
    <div class="">
...
<?php /**PATH C:\laragon\www\fakturator\storage\framework\views/4fab0e3bdcad7c7417c7ebcf72464838ec7f350e.blade.php ENDPATH**/ ?>